...
public enum ErrorCode {
    ...
    USER_TYPE_CANNOT_BE_NULL(101, "User type cannot be null."),
    ...
    TOKEN_WRONG_ISSUER(112, "NOT OUR SITE TOKEN"),
    ...
    FAILED_TO_SEND_EMAIL(138,"FAILED_TO_SEND_EMAIL"),
    RATE_LIMIT_EXCEEDED(139,"RATE LIMIT EXCEEDED"),
    ACCOUNT_CREATION_LIMIT(140,"ACCOUNT CREATION LIMIT"),
    SERVICE_UNDER_MAINTENANCE(150, "SERVICE IS UNDER MAINTENANCE");;
