...
## 💡 서비스 소개 </br>
저희 서비스는 그룹 내에서 공유 정산서 기능을 제공합니다. </br> 무엇보다도, 장기간에 걸쳐 자주 발생하는 지출이 있는 경우(예: 룸메이트, 장기 여행자, 정기적인 모임 등)에 초점을 맞추고 있습니다. 이러한 상황에서는 각 거래 후 즉시 정산하지 않으면 시간이 지날수록 누가 누구에게 얼마만큼의 채무가 있는지 파악하기 어렵습니다. 저희 시스템은 이러한 문제를 해결하기 위해 개발되었습니다.</br>
...
| 1         | 소셜로그인.md                         | 보안관련           |
| 2         | 로그아웃.md                           | 보안관련           |
| 3         | 그룹리스트 불러오기.md                | 그룹관련           |
| 4         | 이메일 검색.md                        | 그룹관련           |
| 5         | 그룹생성.md                           | 그룹관련           |
| 6         | 그룹정보 불러오기.md                  | 그룹관련           |
| 7         | 그룹 탈퇴.md                          | 그룹관련           |
| 8         | 멤버추가.md                           | 그룹관련           |
| 9         | 그룹내 나의 최적화된 자본리스트1.md   | 상세페이지관련    |
| 10        | 그룹내 영수증 리스트2.md             | 상세페이지관련    |
| 11        | 알림 설정                             | 상세페이지관련    |
| 12        | 지난 영수증 보여주기.md               | 상세페이지관련    |
| 13        | 영수증 사진관련하여 외부 api 호출.md | 비용관련          |
| 14        | 새로운 영수증 입력(최적화).md        | 비용관련          |
| 15        | 유저가 송금한 리스트 데이터베이스에 반영.md | 비용관련          |
| 16        | 타인이 나에게 송금한 리스트 불러오기.md  | 비용관련          |
| 17        | 기본세팅입력.md                       | 유저관련          |
| 18        | 기본세팅불러오기.md                   | 유저관련          |
| 19        | ci/cd 도입기 .md                   | 배포관련    |
| 20        | 추후에 개선하고 싶은 부분              | 추후서비스|
...
본프로젝트를 진행하면서 모든 서버를 저 혼자 개발을 해서 전반적인 백엔드 서버에 대해 이해도가 깊어지고 개발하는 방식에대한 체계성이 생겼습니다
